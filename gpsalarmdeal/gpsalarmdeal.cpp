...
void *CoreThread(void *args)
{
	...
	while (1) 
    {
        ...
        if(sizeof(_DEV_GPSWARN_DB) > iconsumerlen)
        {
        ...
        bool bresult = g_dbaccess.AlarmInsertDB(prmqconsumer);
...
int main (int argc, char *argv[], char *envp[])
{
    ...
    strncat(szFileName, "gpsalarmdeal_log.conf", 260);
